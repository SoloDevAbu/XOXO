package com.dreamforgeinteractive.xoxo;
...
//        EdgeToEdge.enable(this);
    ...
    public void Check(View view){
        ...
        if(btnCurrent.getText().toString().isEmpty()) {
            ...
            //Make the pressed button X or O
            //For the odd press we set X and for even press we set to O
            if (flag == 0) {
            ...
            //We have to check when the count is greater than 4, is there is any valid three pairs
            if (count > 4) {
